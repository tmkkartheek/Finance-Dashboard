...
import { ResponsiveContainer,AreaChart,XAxis,YAxis,Tooltip,Area, Line, CartesianGrid, Legend, LineChart,Bar,BarChart,Rectangle} from 'recharts';
    ...
    <>
        <DashboardBox  gridArea='a'>
          <BoxHeader
            ...
            subtitle='top line represents revenue,bottom line represesnts expenses'
            sideText='+4%'
          />
        ...
        <BoxHeader
          ...
          >
            ...
            <XAxis dataKey="name" tickLine={false} style={{fontSize:"10px"}} />
            <YAxis 
            yAxisId='left' tickLine={false} axisLine={false} style={{fontSize:"10px"}}/>
            <YAxis 
            yAxisId='right' orientation='right' tickLine={false} axisLine={false} style={{fontSize:"10px"}}/>
            <Tooltip />
        ...
        <BoxHeader
            ...
            subtitle='graph represents month by month revenue'
            sideText='+4%'
          />
        <ResponsiveContainer width="100%" height="100%">
